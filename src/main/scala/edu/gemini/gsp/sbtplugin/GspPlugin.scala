...
object LucumaPlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val lucumaGlobalSettings = Seq(
      ...
      scalafixDependencies += "com.github.liancheng" %% "organize-imports" % "0.5.0-alpha.1", // Include OrganizeImport scalafix
      addCompilerPlugin(scalafixSemanticdb("4.4.5")) // This is needed for scalafix to run with scala 2.13.4
    )
